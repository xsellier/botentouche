...
/**
 * Wrapper to link a File and a JSONObject instance. Easy saving/loading from file.
 */
public class Configuration extends JSONObject {
    ...
    public JSONObject put(String key, boolean value) throws JSONException {
        if(key.contains(".")) return this.putInPath(key, value);
    ...
    public Object get(String key) throws JSONException {
        if(key.contains(".")) return this.getInPath(key);
        return super.get(key);
    }

    @Override
    public boolean getBoolean(String key) throws JSONException {
        if(key.contains(".")) return ((boolean) this.getInPath(key));
        return super.getBoolean(key);
    }

    @Override
    public double getDouble(String key) throws JSONException {
        if(key.contains(".")) return ((double) this.getInPath(key));
        return super.getDouble(key);
    }

    @Override
    public float getFloat(String key) throws JSONException {
        if(key.contains(".")) return ((float) this.getInPath(key));
        return super.getFloat(key);
    }

    @Override
    public int getInt(String key) throws JSONException {
        if(key.contains(".")) return ((int) this.getInPath(key));
        return super.getInt(key);
    }

    @Override
    public JSONArray getJSONArray(String key) throws JSONException {
        if(key.contains(".")) return ((JSONArray) this.getInPath(key));
        return super.getJSONArray(key);
    }

    @Override
    public JSONObject getJSONObject(String key) throws JSONException {
        if(key.contains(".")) return ((JSONObject) this.getInPath(key));
        return super.getJSONObject(key);
    }

    @Override
    public long getLong(String key) throws JSONException {
        if(key.contains(".")) return ((long) this.getInPath(key));
        return super.getLong(key);
    }

    @Override
    public String getString(String key) throws JSONException {
        if(key.contains(".")) return ((String) this.getInPath(key));
    ...
    private boolean hasInPath(String key) throws JSONException {
        ...
        JSONObject object = this;
        for (int i = 0; i < pathToConfig.size() ; i++) {
            if(i == pathToConfig.size() -1) return object.has(pathToConfig.get(i));
            if(!object.has(pathToConfig.get(i))) return false;
            object = object.getJSONObject(pathToConfig.get(i));
        }
        return false;
    }
    ...
    public boolean has(String key) {
        if(key.contains(".")) return this.hasInPath(key);
    ...
    private Object removePath(String key) {
        ...
        JSONObject object = this;
        for (int i = 0; i < pathToConfig.size() ; i++) {
            if(i == pathToConfig.size() -1) return object.remove(pathToConfig.get(i));
            object = object.getJSONObject(pathToConfig.get(i));
        }
        return null;
    }
    ...
    public Object remove(String key) {
        if(key.contains(".")) return this.removePath(key);
